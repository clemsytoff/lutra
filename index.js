...
Client.on("message", message => {
    ...
    if(message.member.hasPermission("ADMINISTRATOR")){
        ...
        if(message.content.startsWith(prefix + "kick")){
            ...
            if(mention == undefined){
                ...
                if(mention.kickable){
                    mention.kick();
                    message.channel.send(mention.displayName +  " a été kick du serveur avec succès ! ");
                }
                else {
    ...
    if(message.content == prefix + "help"){
     ...
     if(message.content == prefix + "config"){
         message.channel.send("**Vous ne pouvez pas configurer ce bot vous même ! Veuillez contacter le service client !** https://discord.gg/vzRvfesxGM");
     };
});
